...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" abstract="true" id="PEPPOL12-T10">
  ...
  <rule context="$Allowance_Charge">
    ...
    <!-- Removed for SimplerInvoicing <assert test="$EUGEN-T10-R022" flag="fatal" id="EUGEN-T10-R022">[EUGEN-T10-R022]-An allowance or charge amount MUST NOT be negative.</assert> -->
  </rule>
  ...
  <rule context="$Customer">
    <!-- Removed for SimplerInvoicing <assert test="$EUGEN-T10-R036" flag="fatal" id="EUGEN-T10-R036">[EUGEN-T10-R036]-An invoice MUST have a buyer name</assert> -->
    <!-- Removed for SimplerInvoicing <assert test="$EUGEN-T10-R038" flag="fatal" id="EUGEN-T10-R038">[EUGEN-T10-R038]-An invoice MUST have a buyer postal address</assert> -->
  ...
  <rule context="$Supplier">
    <!-- Removed for SimplerInvoicing <assert test="$EUGEN-T10-R035" flag="fatal" id="EUGEN-T10-R035">[EUGEN-T10-R035]-An invoice MUST have a seller name</assert> -->
    <!-- Removed for SimplerInvoicing <assert test="$EUGEN-T10-R037" flag="fatal" id="EUGEN-T10-R037">[EUGEN-T10-R037]-An invoice MUST have a seller postal address</assert> -->
