...
* [SI-UBL 2.0 Invoice and CreditNote (2.0.3.13)](xsl/si-ubl-2.0.xsl)
* [SI-UBL 2.0 G-Account extension (1.0.2.13)](xsl/si-ubl-2.0-ext-gaccount.xsl)
* [NLCIUS UN/CEFACT CII (1.0.3.13)](xsl/nlcius-cii-1.0.xsl)
...
The ready-to-use transformation stylesheets can be found in the `xsl/` directory; there is a separate xsl file for each version of SI-UBL.
...
SI-UBL G-Account extension 1.0.2.13
===================================
...
This schematron definition is based on the CenPC434 schematron, which can be found at:
[https://github.com/ConnectingEurope/eInvoicing-EN16931](https://github.com/ConnectingEurope/eInvoicing-EN16931)
tag validation-1.3.16
