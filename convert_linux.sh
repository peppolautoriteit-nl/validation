#!/bin/bash
export FILE_NAME=SI-UBL-INV.SCH
export CONVERT_BASE=.
export INPUT_FILE=$1
...
do_cmd java -jar ./lib/saxon9he.jar -o:${CONVERT_BASE}/temp/step1_dsdl.xsl ${FILE_NAME} ${CONVERT_BASE}/convert/iso_dsdl_include.xsl
