...
./tools/convert_linux.sh schematron/si-ubl-2.0-RC1.sch xsl/si-ubl-2.0-RC1.xsl
./tools/convert_linux.sh schematron/si-ubl-inv-all.sch xsl/si-ubl-inv-all.xsl
...
saxon-xslt -o documentation/si-ubl-2.0/si-ubl-2.0-rc1-rules-overview.html xsl/si-ubl-2.0-RC1.xsl tools/convert_xsl/rules-overview.xsl
